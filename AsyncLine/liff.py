...
class Liff(Connection):
	...
	async def postFlex(self, to=None, data=None, altText=None):
		"""
		...
		data    = data if data else {"type": "bubble","body": {"type": "box","layout": "vertical","contents": [{"type": "text","align": "center","color": "#00FFF3","text": "Isi datanya !1!1!1","wrap": True,"action": {"type": "uri","uri": url}}]}}
